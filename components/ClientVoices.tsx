...
const testimonials = [
  {
    image: client1,
    quote: "Operational efficiency improved significantly with these drones. Reliable and precise.",
    name: "Alex Ryan",
    role: "Photographer",
  },
  {
    image: client2,
    quote: "Exceptional performance in field conditions. Highly dependable technology.",
    name: "Sam Turner",
    role: "Videographer",
  },
  {
    image: client3,
    quote: "Rugged build and consistent output. Ideal for demanding environments.",
    name: "Chris Weller",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-14 grid gap-8 xl:grid-cols-3">
          {testimonials.map((item, index) => (
            <Reveal key={item.name} delay={400 + index * 100}>
              <article className="rounded-[30px_0px_30px_30px] bg-brand-bg-pink shadow-[0_18px_60px_rgba(185,162,171,0.08)]">
